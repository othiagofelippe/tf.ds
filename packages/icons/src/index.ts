...
import { CheckCheck as LucideCheckCheck } from "lucide-react"
...
import { SearchX as LucideSearchX } from "lucide-react"
...
import { PiggyBank as LucidePiggyBank } from "lucide-react"
...
import { Building2 as LucideBuilding2 } from "lucide-react"
import { CalendarDays as LucideCalendarDays } from "lucide-react"
...
export const SearchX = createIcon(LucideSearchX)
...
export const Circle = createIcon(LucideCircle)
...
export const PiggyBank = createIcon(LucidePiggyBank)
export const Receipt = createIcon(LucideReceipt)
...
export const Compass = createIcon(LucideCompass)
...
export const Tv = createIcon(LucideTv)
export const UserPlus = createIcon(LucideUserPlus)
